...
# Function to create a map of a package's function calls
# Inspired by linnet, written by Martin Krzywinski
# mkweb.bcgsc.ca/linnet
#
# Relies on foodweb in mvbutils by Mark Bravington

FuncMap <- function(fwb = foodweb, pkg = "none",
	method = "abs",
